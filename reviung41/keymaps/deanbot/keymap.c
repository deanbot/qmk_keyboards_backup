...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUM] = LAYOUT_rev(
    TRANS,  ___________________NUM_L1___________________,                   ___________________NUM_R1___________________,   TO(_BASE),
    TRANS,  ___________________NUM_L2___________________,                   ___________________NUM_R2___________________,   TRANS,
  ...
  [_MOUSE] = LAYOUT_rev(
    ...
    TRANS,  _________________MOUSE_L3___________________,                   _________________MOUSE_R3___________________,   TRANS,
                                    MW_DOWN,      MBTN1,        TRANS,          MBTN1,      MW_DOWN
  ),

  [_META] = LAYOUT_rev(
    TRANS,  _________________META_L1____________________,                   _________________META_R1____________________,   RESET,
    TRANS,  _________________META_L2____________________,                   _________________META_R2____________________,   TRANS,
    TRANS,  _________________META_L3____________________,                   _________________META_R3____________________,   TRANS,
                                            __________________BLANK_5___________________
  ),

  [_QWERTY] = LAYOUT_rev(
    TRANS,  ________________QWERTY_L1___________________,                   ________________QWERTY_R1___________________,   TO(_BASE),
    TRANS,  ________________QWERTY_L2___________________,                   ________________QWERTY_R2___________________,   KC_QUOT,
    TRANS,  ________________QWERTY_L3___________________,                   ________________QWERTY_R3___________________,   TRANS,
                                            __________________BLANK_5___________________
  ),
};
// clang-format off
